...
def main():
    ...
    combine(
        ...
        input_onnx_file_paths = [
            f'yolov9_e_wholebody34_with_depth{metric_inout}_post_0100_1x3x{yolo_H}x{yolo_W}.onnx',
            f'peopleseg_1x3x{yolo_H}x{yolo_W}.onnx',
        ],
        output_onnx_file_path = f'yolov9_e_wholebody34_with_depth{metric_inout}_seg_post_0100_1x3x{yolo_H}x{yolo_W}.onnx',
    )
    combine(
        srcop_destop = [
            ['segment', 'input_post_seg', 'depthanything/post/Concat_1_output_0', 'seg/post/Concat_1_output_0']
        ],
        input_onnx_file_paths = [
            f'yolov9_e_wholebody34_with_depth{metric_inout}_seg_post_0100_1x3x{yolo_H}x{yolo_W}.onnx',
